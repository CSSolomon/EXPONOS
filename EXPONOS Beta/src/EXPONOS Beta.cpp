...
int main() {
	...
	while (true) {
		...
		while (true) {
			...
			cin >> main_menu;
			if (main_menu == "10") { system("cls"); notes(); continue; }
			if (main_menu == "8") { system("start cmd.exe"); continue; }
			if (main_menu == "03") { EXPONOS expo; expo.functi(); system("cls"); break; }
			if (main_menu == "9") {
				system("cls");
				cout << "1. Red\n2. Green\n3. Blue\n4. Purple\n5. Yellow\n6. Aqua\n7. White\n8. Gray\n9. Black\n0. Reset\n";
				int co;
